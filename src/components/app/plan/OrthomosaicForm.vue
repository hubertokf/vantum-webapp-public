<template>
  <div class="orthomosaic-form">
    <div class="content">
      ...
      <div class="georefWarning warning" v-if="showDropzone">
        Atenção, envie apenas imagens georreferenciadas.
      </div>
      ...
      <file-upload
        ...
        :uploadPath="
          'user_data/' + userFolder + '/orthomosaics/' + orthomosaic.id + '/'
        "
        :showButton="false"
...
export default {
  ...
  methods: {
    ...
    async vqueueComplete(file, xhr, formData, orthomosaic) {
      ...
      this.$emit("complete", this.orthomosaic);
