          ...
          <div class="login-box" :class="{ 'pro-login': isPro }">
            <div class="form-content">
              <h1>
                Acesse sua conta
                <br />
                <span v-if="isPro">Profissional</span>
              </h1>
              ...
              <div class="normalLogin" v-if="isPro" @click="isPro = false">Login de usuários</div>
            </div>
          </div>
        </div>
      </div>
...
import InstallPwaAlert from "@/components/app/InstallPwaAlert";
let installEvent;
